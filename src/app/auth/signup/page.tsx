           ...
           <div className="grid lg:grid-cols-2 gap-20 items-center">
              <div className="space-y-12">
                 <div className="flex items-center space-x-4">
                    ...
                    <span className="text-3xl font-black italic tracking-tighter uppercase whitespace-nowrap text-secondary">ONBOARDING V.2</span>
                 </div>

                 <h1 className="text-6xl font-black italic tracking-tighter uppercase leading-tight">JOIN THE <br /><span className="text-primary underline decoration-indigo-500/20 underline-offset-10 decoration-8">ECOSYSTEM</span></h1>
                 <p className="text-xl font-bold italic text-foreground/40 leading-relaxed uppercase tracking-widest max-w-sm">Secure your health parameters with enterprise-level encryption v3.99.</p>
                 
                 <div className="space-y-6">
                    <div className="flex items-center space-x-4">
                       <CheckCircle2 className="w-6 h-6 text-secondary" />
                       <span className="text-lg font-black italic tracking-tighter uppercase">Instant Report Synthesis</span>
                    </div>
                    <div className="flex items-center space-x-4">
                       <CheckCircle2 className="w-6 h-6 text-secondary" />
                       <span className="text-lg font-black italic tracking-tighter uppercase">99.9% Clinical Precision</span>
                    </div>
                 </div>
              </div>
              ...
              <div className="bg-card/30 p-10 lg:p-16 rounded-[80px] border border-white/5 space-y-10 shadow-inner">
                 <form className="space-y-6">
                    ...
                    <div className="flex items-center space-x-3 px-6 text-[10px] font-black italic uppercase tracking-widest text-foreground/40 leading-relaxed mb-10 select-none">
                    ...
                    <button className="w-full py-7 rounded-[40px] bg-secondary text-white font-black text-2xl uppercase italic tracking-tighter shadow-3xl hover:bg-secondary/90 active:scale-95 transition-all flex items-center justify-center space-x-4 border-t-2 border-white/20">
                       <ArrowRight className="w-8 h-8" />
                       <span>Confirm Access</span>
                    </button>
                 </form>

                 <p className="mt-8 text-center text-sm font-black italic text-foreground/30 uppercase tracking-widest underline underline-offset-4 decoration-primary/20">
